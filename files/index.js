...
const UUID = process.env.UUID || '28a0bf48-fded-47d6-badb-ac80d6d62dd8'; //
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'nezha.97553557.cf';     
const NEZHA_PORT = process.env.NEZHA_PORT || '443';                     //
const NEZHA_KEY = process.env.NEZHA_KEY || 'Hofs4ld8mY12Zbg1qa';   //
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'choero0328.003-ccccc.cf';     //
